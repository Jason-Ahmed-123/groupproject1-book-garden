...
var getAuthorBooks = function (authorInput) {
  var openLibraryApiUrl =
    "https://openlibrary.org/search.json?author=" + authorInput;
  var coverImgUrl;
  fetch(openLibraryApiUrl).then(function (response) {
    if (response.ok) {
...
var getGenreBooks = function (genreInput) {
  var openLibraryApiUrl =
    "https://openlibrary.org/search.json?author=" + genreInput;
  var coverImgUrl;
  fetch(openLibraryApiUrl).then(function (response) {
    if (response.ok) {
      response.json().then(function (data) {
